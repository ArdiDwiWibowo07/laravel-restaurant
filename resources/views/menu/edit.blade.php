                    ...
                    <div class="card-body">
                        <form action="{{ route('pelanggan.update',$pelanggan->kode_pelanggan) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('no_wa') is-invalid @enderror" name="no_wa" value="{{ old('no_wa', $pelanggan->no_wa) }}" placeholder="Masukkan Nomor Whatsapp">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('alamat', $pelanggan->alamat) }}" placeholder="Masukkan Alamat">
